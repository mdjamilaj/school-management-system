...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub fa-xs fa-spin" aria-hidden="true"></i> scholarly </a></h1>
...
<div class="about-bottom">
	<div class="col-md-6 w3l_about_bottom_left">
		<div class="video-grid-single-page-agileits">
			<div data-video="E91gAjunqOM" id="video"> <img src="images/bannerjamil.jpg" alt="" class="img-responsive" /> </div>
		</div>
	...
	<div class="container">
		...
		<div class="team-w3l-grid">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/jamil2.png" alt="">
				  <h5>MD JAMIL AJ</h5>
				  <div class="about_opa">
					<p>Professor</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="https://www.facebook.com/md.jamilahmed.7946?ref=bookmarks"></a></li>
						<li><a class="fa fa-twitter" href="https://twitter.com/MdjamilAJ1"></a></li>
						<li><a class="fa fa-google" href="mdjamilaj1@gmail.com"></a></li>
						<li><a class="fa fa-linkedin" href="https://www.linkedin.com/in/md-jamil-aj-0b931a196/"></a></li>
						<li><a class="fa fa-pinterest-p" href="https://www.pinterest.com/mdjamilaj/"></a></li>
					</ul>
				  </div>
				</div>
			</div>
		...
		<div class="team-w3l-grid grid-2-team">
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/jamil1.png" alt="">
				  <h5>MD Jamil</h5> <div class="about_opa">
					<p>Senior Lecturers</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="https://www.facebook.com/md.jamilahmed.7946?ref=bookmarks"></a></li>
						<li><a class="fa fa-twitter" href="https://twitter.com/MdjamilAJ1"></a></li>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2019 Scholarly. All rights reserved | Design by <a href="http://aj~style.com">AJ~STYLE.</a> Developed By MD JAMIL AJ</p>
	</div>
</div>
	<?php } else{ ?>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2019 Scholarly. All rights reserved | Design by <a href="http://w3layouts.com">AJ~STYLE.</a> Developed By MD JAMIL AJ</p>
	</div>
</div>
	<?php }?>
	<!-- //footer -->
