	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="inner-content">
						...
						<div class="tab-inner">
							<div id="tabs" class="tabs">
								<h2 class="inner-tittle">Welcome,
									<span style="color: red"><?php echo ucfirst($student_name_display['st_fullname']); ?> </span></h2>
								<div class="graph">
									<nav>
										<ul>
				...
				<footer>
					<p>&copy; 2019 Augment . All Rights Reserved | Design by <a href="https://w3layouts.com/" target="_blank">AJ~STYLE.</a> and Develop By MD JAMIL AJ</p>
				</footer>
				<!--footer section end-->
			</div>
		</div>
		...
		<div class="sidebar-menu">
			...
			<!--/down-->
			<div class="down">
				<a href="index.html"><img src="images/jamil_profile4.png"></a>
